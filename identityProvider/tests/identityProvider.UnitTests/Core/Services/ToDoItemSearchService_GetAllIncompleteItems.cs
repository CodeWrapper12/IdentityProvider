...
using identityProvider.Core.ProjectAggregate;
using identityProvider.Core.Services;
using identityProvider.SharedKernel.Interfaces;
using Moq;
using Xunit;

namespace identityProvider.UnitTests.Core.Services
{
